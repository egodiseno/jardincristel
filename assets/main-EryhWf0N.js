...
`;document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll('a[href^="#"]').forEach(t=>{t.addEventListener("click",function(l){l.preventDefault();const n=this.getAttribute("href").substring(1),a=document.getElementById(n);a&&window.scrollTo({top:a.offsetTop,behavior:"smooth"})})})});document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("menu-toggle"),t=document.getElementById("mobile-menu"),l=document.getElementById("close-menu");e.addEventListener("click",()=>{t.classList.toggle("-translate-y-full")}),l.addEventListener("click",()=>{t.classList.add("-translate-y-full")}),document.querySelectorAll("#mobile-menu a").forEach(n=>{n.addEventListener("click",()=>{t.classList.add("-translate-y-full")})})});const v=document.querySelectorAll("nav a"),x=document.querySelectorAll("section");function b(){let e=x.length;for(;--e&&window.scrollY+50<x[e].offsetTop;);v.forEach(t=>t.classList.remove("active")),v[e].classList.add("active")}window.addEventListener("scroll",b);b();const f=document.querySelectorAll("#galeria img"),c=Array.from(f),d=document.getElementById("lightbox"),w=document.getElementById("lightbox-img"),y=document.getElementById("close-lightbox"),C=document.getElementById("prev"),k=document.getElementById("next");let r=0;function m(e){w.src=c[e].src,d.classList.remove("hidden"),r=e}c.forEach((e,t)=>{e.addEventListener("click",()=>{m(t)})});y.addEventListener("click",()=>{d.classList.add("hidden")});d.addEventListener("click",e=>{e.target===d&&d.classList.add("hidden")});C.addEventListener("click",()=>{r>0?r--:r=c.length-1,m(r)});k.addEventListener("click",()=>{r<c.length-1?r++:r=0,m(r)});document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("cta"),t=document.getElementById("contacto");let l=!1;function n(){window.scrollY||document.documentElement.scrollTop,o(t)?e.classList.add("hidden"):e.classList.remove("hidden"),l=!1}function a(){l||(window.requestAnimationFrame(()=>{n()}),l=!0)}function o(s){const p=s.getBoundingClientRect();return p.top<(window.innerHeight||document.documentElement.clientHeight)&&p.bottom>=0}window.addEventListener("scroll",a)});const u=document.querySelector("#cta-button");let g=!1;function L(){u.classList.add("glowing")}function z(){setTimeout(()=>{u.classList.remove("glowing"),u.classList.add("fade-out")},5e3)}function h(){!g&&window.scrollY>100&&(L(),z(),g=!0,window.removeEventListener("scroll",h))}window.addEventListener("scroll",h);const i=document.getElementById("modal"),M=document.querySelectorAll('a[href="#"]'),B=document.getElementById("closeModal");M.forEach(e=>{e.addEventListener("click",t=>{t.preventDefault(),i.classList.remove("hidden"),i.classList.add("flex");const l=i.querySelector("div");l.classList.remove("modal-exit-active"),l.classList.add("modal-enter"),setTimeout(()=>{l.classList.remove("modal-enter"),l.classList.add("modal-enter-active")},50),document.body.classList.add("overflow-hidden")})});B.addEventListener("click",()=>{const e=i.querySelector("div");e.classList.remove("modal-enter-active"),e.classList.add("modal-exit-active"),setTimeout(()=>{i.classList.add("hidden"),i.classList.remove("flex"),e.classList.remove("modal-exit-active"),document.body.classList.remove("overflow-hidden")},300)});document.addEventListener("DOMContentLoaded",function(){const e=document.getElementById("modal"),t=document.getElementById("title-modal"),l=document.getElementById("closeModal");document.querySelectorAll(".open-modal").forEach(a=>{a.addEventListener("click",function(){console.log("Botón clicado");const o=this.getAttribute("data-title");console.log("Título del evento: ",o),o&&(t.textContent=o),e.classList.remove("hidden"),e.classList.add("flex"),e.querySelector("div").classList.remove("scale-0"),e.querySelector("div").classList.add("scale-100")})}),l.addEventListener("click",function(){e.classList.add("hidden"),e.classList.remove("flex"),e.querySelector("div").classList.add("scale-0"),e.querySelector("div").classList.remove("scale-100")})});
